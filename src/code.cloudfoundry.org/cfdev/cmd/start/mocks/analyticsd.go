...
// Source: code.cloudfoundry.org/cfdev/cmd/start (interfaces: AnalyticsD)
...
func (m *MockAnalyticsD) Watch(arg0 chan string) {
	m.ctrl.Call(m, "Watch", arg0)
}

// Watch indicates an expected call of Watch
func (mr *MockAnalyticsDMockRecorder) Watch(arg0 interface{}) *gomock.Call {
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "Watch", reflect.TypeOf((*MockAnalyticsD)(nil).Watch), arg0)
}
